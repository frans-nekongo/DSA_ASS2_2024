...
public function main() returns error? {
    ...
    while true {
        ...
        do {
            ...
            // / []]]]]]]]]][][]] send request to requesttable in db and send the results to the ExpressDeliveryReply ][ ][][] [] [ ] ]]

            string ExpressDeliveryRequestResult = check insertIntoRequestTable(request);
...
// Function to process ExpressDelivery requests
...
function insertIntoRequestTable(StandardDeliveryRequestData request) returns string|error {
    ...
    log:printInfo("Successfully sent package id to ExpressDeliveryReply topic.");
