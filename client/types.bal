...
# Represents the Queries record for the operation: getPackageStatus
public type GetPackageStatusQueries record {
    string packageId;
};

# Represents the Queries record for the operation: checkAvailability
public type CheckAvailabilityQueries record {
    string date;
    string town;
    string slot;
};
